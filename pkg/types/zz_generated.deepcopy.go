...
func (in *VarsSource) DeepCopyInto(out *VarsSource) {
	*out = *in
	...
	if in.GcpSecretsManager != nil {
		...
		*out = new(VarsSourceGcpSecretsManager)
		**out = **in
	}
	if in.Vault != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VarsSourceGcpSecretsManager) DeepCopyInto(out *VarsSourceGcpSecretsManager) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VarsSourceGcpSecretsManager.
func (in *VarsSourceGcpSecretsManager) DeepCopy() *VarsSourceGcpSecretsManager {
	if in == nil {
		return nil
	}
	out := new(VarsSourceGcpSecretsManager)
