...
def test_external_kluctl_project(kind_cluster: KindCluster):
    do_test_project(kind_cluster, "external-kluctl-project", kluctl_project_external=True)

def test_external_clusters_project(kind_cluster: KindCluster):
    do_test_project(kind_cluster, "external-clusters-project", clusters_external=True)

def test_external_deployment_project(kind_cluster: KindCluster):
    do_test_project(kind_cluster, "external-deployment-project", deployment_external=True)

def test_external_sealed_secrets_project(kind_cluster: KindCluster):
    do_test_project(kind_cluster, "external-sealed-secrets-project", sealed_secrets_external=True)

def test_all_projects_external(kind_cluster: KindCluster):
    do_test_project(kind_cluster, "external-all-projects",
